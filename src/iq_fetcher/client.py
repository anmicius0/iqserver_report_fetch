...
class Application(BaseModel):
    id: str
    public_id: str = Field(alias="publicId")  # Use alias for snake_case conversion
    name: str
...
class ReportInfo(BaseModel):
    ...
    report_data_url: Optional[str] = Field(None, alias="reportDataUrl")
...
class Organization(BaseModel):
    id: str
    name: str
    parent_organization_id: Optional[str] = Field(None, alias="parentOrganizationId")
